...
class Person:
    ...
    def introduce_yourself(self):
        print(f"Hello,my name is {self.name} {self.surname} and I'm {self.age} years old. My hometown is in {self.country}. It's called {self.city}.")

    def age_difference(self,input_age):
        if input_age<self.age:
            print(f"I'm {self.age-input_age} years older than you.")
        elif input_age>self.age:
            print(f"You're {input_age-self.age} years older than me.")
        else:
...
class Student(Person):
    ...
    def introduce_yourself(self):
        print(f"Hello, my name is {self.name} {self.surname} and I'm {self.age} years old .I go to university called {self.university}.My faculty named {self.faculty}.")
...
class Teacher(Person):
    ...
    def threat(self,students_name):
        print(f"Did you leave your head at home? I'll call your parents, {students_name}.")
...
student_1=Student("Ulinka","Farington",24,"Croatia","Zagreb",2345,"Josip Juraj Strossmayer University of Osijek","World economy")
student_1.introduce_yourself()
print(student_1.return_student_ID("Josip Juraj Strossmayer University of Osijek","Ulinka"))

teacher_1=Teacher("Nurbel","Kazulnutova",37,"Kazakhsan","Astana","Al-Farabi Kazakh National University","english teacher",100)
